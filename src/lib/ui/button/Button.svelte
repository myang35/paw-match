<script lang="ts">
	...
	type Props = {
		color?: 'transparent' | 'primary' | 'secondary' | 'light' | 'dark';
		children?: Snippet;
	} & HTMLButtonAttributes;

	let { color = 'transparent', children, ...buttonProps }: Props = $props();
</script>

<button
	{...buttonProps}
	class={[
		color === 'transparent' && 'transition-colors hover:bg-black/20',
		color === 'primary' &&
